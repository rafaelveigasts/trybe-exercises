...
const sendMarsTemperature = (onSucess, onError) => {
  ...
  setTimeout(() => {
    if(messageSucessfullySent) onSucess(currentTemperature)
    else onError('robot is busy');
  }, 1000);
}

// Observação: mesma coisa do exercicio anterior só que agora adicionando um if para mensagem de erro. A taxa de acerto é defidina na linha 23
